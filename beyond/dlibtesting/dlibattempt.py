...
for i in range(len(points)):
    points[i].printPoint()
print("Time to get swifty in here now!")
for i in range(len(points)):
    points[i].swiftyProtocol(minX,minY,maxX,maxY)
    points[i].printPoint()
print(str(minX) + " " + str(minY))
print("Adjusted MaxX - MinX")
print("Max X = " + str(maxX) + " MinX = " + str(minX))
print(maxX-minX)
print("Adjusted MaxY - MinY")
print("Max Y = " + str(maxY) + " MinY = " + str(minY))
print(maxY-minY)
print("This is R")
print(math.sqrt(float(math.pow((maxX-minX),2) + math.pow((maxY-minY),2))))
